...
public class RQSortByAscending extends rQfilters {
    public RQSortByAscending (rQcolumns req) {
        setName("По возрастанию", "Ascending");
        setColumn(req);
    }
    protected void requestMenu () {
        ...
        if (getTour().length > 0) {
            ...
            str.append("Вот список всех туров, в возрастающем порядке по столбцу '").append(getColumn().getName()[0]).append("':\n");
